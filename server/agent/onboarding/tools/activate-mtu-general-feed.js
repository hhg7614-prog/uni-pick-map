...
function main() {
  console.error(
    "[DEPRECATED] server/agent/onboarding/tools/activate-mtu-general-feed.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-mtu-general-feed.js is deprecated and no longer performs source activation. " +
