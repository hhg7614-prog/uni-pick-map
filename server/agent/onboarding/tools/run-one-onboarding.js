...
// the source catalog (and could even commit/push) without going through
// Brain's review + signed approval. It has been replaced by the
// review-packet -> signed ReviewDecision -> --apply flow:
//
...
//
// This stub never touches the source catalog, the news store, the preview
// file, or git. It only logs the attempted invocation (for audit purposes)
// and throws immediately.

function main() {
  console.error(
    "[DEPRECATED] server/agent/onboarding/tools/run-one-onboarding.js was invoked but is retired. " +
  ...
  throw new Error(
    "run-one-onboarding.js is deprecated and no longer performs source activation. " +
