...
function main() {
  console.error(
    "[DEPRECATED] server/agent/onboarding/tools/activate-youngsan-shared-feed.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-youngsan-shared-feed.js is deprecated and no longer performs source activation. " +
