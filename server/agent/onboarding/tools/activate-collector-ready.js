...
function main() {
  console.error(
    "[DEPRECATED] server/agent/onboarding/tools/activate-collector-ready.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-collector-ready.js is deprecated and no longer performs source activation. " +
