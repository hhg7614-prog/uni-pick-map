...
function main() {
  console.error(
    "[DEPRECATED] server/agent/onboarding/tools/activate-kyungnam-general-feed.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-kyungnam-general-feed.js is deprecated and no longer performs source activation. " +
