...
function main() {
  console.error(
    "[DEPRECATED] server/agent/onboarding/tools/activate-ulsan-general-feed.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-ulsan-general-feed.js is deprecated and no longer performs source activation. " +
