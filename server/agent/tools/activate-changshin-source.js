...
// parseDate, extractRows, extractPostAnchor, extractExactDateCell,
...
// activate-changshin-source.js 항목 참고), so they were removed along with
// the activation logic rather than preserved.

function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/activate-changshin-source.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-changshin-source.js is deprecated and no longer performs source activation. " +
