...
// helper functions (normalizeId, plain, normalizeUrl, officialDomain,
// parseDate, extractRows, extractGoViewIds, extractTitleCandidates,
// analyzeRow, titleKey, titleMatches, dateMatches, validateDetail,
// snapshotHashes). A repo-wide search confirmed no other file required this
// module or consumed those exports (.pipeline/spec.md "Coder 2라운드 대상"
// activate-hwasung-medi-science-source.js 항목 참고), so they were removed
// along with the activation logic rather than preserved.

function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/activate-hwasung-medi-science-source.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-hwasung-medi-science-source.js is deprecated and no longer performs source activation. " +
