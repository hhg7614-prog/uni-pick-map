...
function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/activate-sangmyung-cheonan-source.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-sangmyung-cheonan-source.js is deprecated and no longer performs source activation. " +
