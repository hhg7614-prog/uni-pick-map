...
function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/activate-kyungwoon-source.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-kyungwoon-source.js is deprecated and no longer performs source activation. " +
