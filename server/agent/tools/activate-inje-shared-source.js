...
function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/activate-inje-shared-source.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-inje-shared-source.js is deprecated and no longer performs source activation. " +
