...
function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/activate-daeshin-source.js was invoked but is retired. " +
  ...
  throw new Error(
    "activate-daeshin-source.js is deprecated and no longer performs source activation. " +
