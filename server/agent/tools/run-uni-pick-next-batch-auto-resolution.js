...
// the source catalog (with an --apply flag of its own, pre-dating the gate)
...
function main() {
  console.error(
    "[DEPRECATED] server/agent/tools/run-uni-pick-next-batch-auto-resolution.js was invoked but is retired. " +
  ...
  throw new Error(
    "run-uni-pick-next-batch-auto-resolution.js is deprecated and no longer performs source activation. " +
